 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = 0.01 * (vershoks * 4.445 + arshins * (48 / 3.0) * 4.445 + sagenes * 48 * 4.445)
 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (PI / 180) * (deg + (min * 1 / 60.0) + sec * (1 / 60.0) * (1 / 60.0))
...
fun numberRevert(number: Int): Int {
    ...
    return original.reversed().toInt()
}
